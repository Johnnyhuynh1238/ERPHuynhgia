...
.gv-sum{background:linear-gradient(135deg,#fff,#fbf1e6);border:1px solid var(--line);border-left:5px solid var(--pa);border-radius:14px;padding:16px 20px;margin-bottom:16px}
...
.gv-card.nc{border-left:5px solid #1f8a4c}
...
.gv-card.nc .gv-hd{background:#eef6ee}
