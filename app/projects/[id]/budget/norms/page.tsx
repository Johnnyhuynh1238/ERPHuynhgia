...
import { NormsClient } from "./_components/norms-client";

export const metadata = { title: "Bảng định mức" };

export default async function BudgetNormsPage({ params }: { params: { id: string } }) {
