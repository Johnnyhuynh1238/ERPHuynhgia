...
export default async function MorningReportHomePage() {
  ...
  if (projects.length === 1) {
    redirect(`/reports/morning/${projects[0].id}`);
  }

  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-semibold text-orange-300">Báo cáo sáng</h1>
      <ReportingHomeClient
